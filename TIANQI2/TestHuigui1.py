...
data = pd.read_csv(r'D:/Users/文档/编程/Python/TIANQI2/NanChang10Mouth2.csv')
...
xTrain = np.array(lows,dtype=np.int)[:, np.newaxis]
# 为方便理解，也转换成列向量
